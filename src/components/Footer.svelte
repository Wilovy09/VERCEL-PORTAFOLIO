<footer class="w-full bg-black">
    <div class="container px-6 py-1 mx-auto">
        <hr class="my-4 border-white md:my-10">
        <div class="flex flex-col items-center justify-center sm:flex-row">
            <a href="/">
                <img class="w-auto h-10 text-white" src="/icon.svg" alt="LOGO">
            </a>
        </div>
        <div class="grid grid-cols-1">
            <div class="flex justify-center" id="contacto">
                <form action="https://formsubmit.co/2b5b1cfde6ef3a9c8352393206e2127e" method="POST">

                    <label for="Nombre" class="block mb-2 text-2xl text-white">Nombre</label>
                    ...
                    <div class="relative mb-6">
                        ...
                        <input type="text" name="whatsapp" id="whatsapp" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full pl-10 p-2.5" placeholder="+52 8186816362">
                    </div>
                    ...
                    <input type="hidden" name="_next" value="https://wilovy.com/mensaje_enviado">
                </form>
            </div>
            
            <div class="flex gap-4 justify-center py-10 text-white" id="social">
                <a href="https://wa.me/+528186816362" target="_blank">
                    <svg width="40" height="40" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 21l1.65 -3.8a9 9 0 1 1 3.4 2.9l-5.05 .9" /><path d="M9 10a.5 .5 0 0 0 1 0v-1a.5 .5 0 0 0 -1 0v1a5 5 0 0 0 5 5h1a.5 .5 0 0 0 0 -1h-1a.5 .5 0 0 0 0 1" /></svg>
                </a>
                <a href="https://www.linkedin.com/in/emiliano-maldonado-garza/" target="_blank">
                    <svg width="40" height="40" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z" /><path d="M8 11l0 5" /><path d="M8 8l0 .01" /><path d="M12 16l0 -5" /><path d="M16 16v-3a2 2 0 0 0 -4 0" /></svg>
                </a>
                <a href="https://www.instagram.com/omfg_09/" target="_blank">
                    <svg width="40" height="40" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 4m0 4a4 4 0 0 1 4 -4h8a4 4 0 0 1 4 4v8a4 4 0 0 1 -4 4h-8a4 4 0 0 1 -4 -4z" /><path d="M12 12m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" /><path d="M16.5 7.5l0 .01" /></svg>
                </a>
                <a href="https://twitter.com/omfg_09" target="_blank">
                    <svg width="40" height="40" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 4l11.733 16h4.267l-11.733 -16z" /><path d="M4 20l6.768 -6.768m2.46 -2.46l6.772 -6.772" /></svg>
                </a>
                <a href="https://codepen.io/Wilovy-09" target="_blank">
