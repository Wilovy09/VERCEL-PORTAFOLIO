...
<section class="py-24" id="proyectos">
    ...
    <div class="flex justify-center">
        ...
        <div class="gap-6 px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <Card title="Express & Prisma con Svelte" description="Mi primera CRUD API usando Express & Prisma" github="https://github.com/Wilovy09/Svelte-Express-Prisma-CRUD" img="https://github.com/Wilovy09/SVELTE_EXPRESS_PRISMA_SUPABASE_API/blob/master/readIMAGES/Screenshot_select-area_20231208194555.png?raw=true"/>
